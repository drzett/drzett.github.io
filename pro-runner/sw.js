...
const PATCH_BUILD='2026-09-12.8';
const PATCH_CACHE=`pro-runner-patch-${PATCH_VERSION}`;
const PATCH_ASSETS=['./index.html','./update-ui.js','./update-ui-core.js','./springboard-v14.js','./v142-ui.js','./icon-designer.js','./v150-home.js','./v161-springboard.js','./v153-fixes.js','./v151-online.js','./v152-icon-fix.js','./v153-touch.js','./external-frame.html'];
