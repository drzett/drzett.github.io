...
| Website viewer | Embedded website launch, reload, navigation controls and an external-browser fallback where embedding is blocked. | **Partial**: the viewer cannot bypass third-party CSP/X-Frame-Options. “Open in browser” remains available in the three-dot menu without obscuring embedded app controls. | website viewer module |
